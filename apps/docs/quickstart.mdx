...
## 2. Import better-cmdk styles

better-cmdk ships precompiled styles:
...
Then optionally override better-cmdk's namespaced tokens.

<Accordion title="CSS variables">
  These are better-cmdk's namespaced tokens. Override them to match your brand.
  ...
  .bcmdk-root {
    ...
    --bcmdk-accent: 0.97 0 0;
    --bcmdk-accent-foreground: 0.205 0 0;
