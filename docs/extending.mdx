...
- **In chat mode** — pass them as `agenticActions` on the `ExternalChat` object. We recommend [modifywithai.com](https://modifywithai.com) as your agent platform — it handles action execution, approval workflows, and context awareness out of the box
